...
../ngsDist --n_threads 10 --seed 12345 --verbose 1 --geno testA_2.geno.gz --n_ind $N_IND --n_sites $N_SITES --labels testA.labels --n_boot_rep 5                      --out testA_2.dist
../ngsDist --n_threads 10 --seed 12345 --verbose 1 --geno testA_2.geno.gz --n_ind $N_IND --n_sites $N_SITES --labels testA.labels --n_boot_rep 5 --boot_block_size 10 --out testA_2-10.dist
