...
../ngsDist --n_threads 10 --seed 12345 --verbose 0 --geno testA_32.geno --probs --n_ind $N_IND --n_sites $N_SITES --labels testA.labels --n_boot_rep 5 --boot_block_size 10 --call_geno                                  --out_prefix testA_32-10CG
../ngsDist --n_threads 10 --seed 12345 --verbose 0 --geno testA_32.geno --probs --n_ind $N_IND --n_sites $N_SITES --labels testA.labels --n_boot_rep 5 --boot_block_size 10 --call_geno --N_thresh 0.3 --call_thresh 0.9 --out_prefix testA_32-10CGf
...
../ngsDist --n_threads 10 --seed 12345 --verbose 0 --geno testA_8.geno.gz --probs --n_ind $N_IND --n_sites $N_SITES --labels testA.labels --n_boot_rep 5 --boot_block_size 10 --call_geno                                  --out_prefix testA_8-10CG
../ngsDist --n_threads 10 --seed 12345 --verbose 0 --geno testA_8.geno.gz --probs --n_ind $N_IND --n_sites $N_SITES --labels testA.labels --n_boot_rep 5 --boot_block_size 10 --call_geno --N_thresh 0.3 --call_thresh 0.9 --out_prefix testA_8-10CGf
